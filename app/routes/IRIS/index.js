                    ...
                    <div class="container">
                        ...
                        <div class="navbar-collapse collapse justify-content-end" id="navbarDefault">
                            <ul class="navbar-nav">
                                ...
                                <!--/
          <li class="nav-item">
            <a class="button js-scroll px-4" href="#about" role="button">Tienda</a>
          </li>
          /-->
                            </ul>
                        </div>
            ...
            <footer>
                ...
                <a href="https://api.whatsapp.com/send?phone=5531359964&text=Hola%21%20Quisiera%20m%C3%A1s%20informaci%C3%B3n%20sobre%20IRIS%202." class="float" target="_blank">
